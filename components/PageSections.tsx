...
import { 
  ...
  ThumbsUp, X as XIcon, FileText, Gift
} from 'lucide-react';
...
import { 
  ...
  CONTACT_FORM_ACTION_URL, PRICING_PLANS, FLEXIBLE_PRICING_FEATURES
} from '../constants';
      ...
      <div className="relative container max-w-7xl mx-auto px-6 z-10 flex flex-col md:flex-row items-center gap-12 mt-16">
        ...
        <div className="md:w-3/5 text-left space-y-8 animate-fade-in-up">
           ...
           <div className="flex flex-wrap gap-4 pt-2">
            ...
            >
              Book a free session <ArrowRight size={20} />
            </Link>
            <Link 
              to="/academics" 
...
export const AcademicHighlights: React.FC = () => {
  const features = [
    { title: "SATs", desc: "Prepare your child for Year 6 National Assessments with engaging, structured lessons and experienced primary educators.", icon: Sparkles, targetId: "sats-highlight", path: "/academics", color: "border-b-amber-500", iconBg: "bg-amber-50", iconColor: "text-amber-600" },
        ...
        <div className="flex flex-col gap-12 lg:grid lg:grid-cols-12 lg:gap-20 items-start">
          ...
          <div className="order-2 w-full lg:col-span-7 lg:col-start-6">
            <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-2xl shadow-slate-200 border border-slate-100 relative overflow-hidden group">
               ...
               <h3 className="text-2xl font-serif font-bold text-school-navy mb-2">To Book a free session or for any inquiries</h3>
...
export const ModernShowcase: React.FC = () => {
  ...
  return (
    <div className="space-y-0 relative">
      ...
      {/* SATs Section */}
      <section id="sats-highlight" className="py-24 lg:py-32 w-full scroll-mt-48 relative overflow-hidden group">
        <div className="absolute top-0 left-0 w-[55%] h-full bg-amber-50/40 skew-x-6 -z-20 hidden lg:block origin-bottom-left"></div>
        
        <div className="container max-w-7xl mx-auto px-6 relative z-10">
          <div className="absolute top-20 right-0 lg:right-0 text-[180px] lg:text-[240px] font-serif font-bold text-amber-100 -z-10 select-none leading-none opacity-60">00</div>
  
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            <div className="lg:w-1/2 space-y-8 relative">
               <div className="absolute -top-10 -left-10 w-24 h-24 bg-amber-400/20 rounded-full blur-2xl animate-pulse"></div>
  
              <div className="relative inline-block">
                 <h2 className="text-5xl lg:text-7xl font-serif font-bold text-transparent bg-clip-text bg-gradient-to-r from-school-navy to-amber-900 uppercase tracking-wide leading-none drop-shadow-sm">
                   SATs
                 </h2>
                 <div className="h-3 w-3/4 bg-amber-300 absolute bottom-2 left-0 -z-10 rounded-full opacity-40"></div>
              </div>
  
              <div className="space-y-4">
                 <h3 className="text-2xl font-bold text-school-navy">Build Core Confidence with Expert Online SATs Tutors</h3>
                 <p className="text-gray-600 text-lg leading-relaxed">
                   Prepare your child for their Year 6 National Assessments with engaging, structured lessons and experienced primary educators. Our targeted approach focuses on mastering fundamental Maths and English skills—including reading comprehension and SPaG (Spelling, Punctuation, and Grammar)—ensuring students feel confident, fully prepared, and stress-free ahead of exam week.
                 </p>
                 
                 {/* Feature Pills */}
                 <div className="flex flex-wrap gap-3 pt-2">
                    {["1 to 1 Sessions", "Small groups", "Past Paper Practice", "Mock Test"].map((tag, i) => (
                      <span key={i} className="px-4 py-1.5 rounded-full bg-amber-50 text-amber-600 font-bold text-xs uppercase tracking-wide border border-amber-100">
                        {tag}
                      </span>
                    ))}
                 </div>
              ...
              <div className="pt-4">
                 <Link 
                    to="/academics"
                    className="group inline-flex items-center gap-3 px-8 py-4 bg-school-navy text-white rounded-full font-bold hover:bg-amber-600 transition-all shadow-lg hover:shadow-amber-900/30 transform hover:-translate-y-1"
                 >
                   Explore SATs Curriculum 
            ...
            <div className="lg:w-1/2 relative perspective-1000">
               <div className="absolute inset-0 bg-gradient-to-tr from-amber-200 to-amber-50 rounded-3xl lg:rounded-tl-[100px] lg:rounded-br-[100px] transform rotate-3 scale-95 z-0 transition-transform duration-500 group-hover:rotate-0"></div>
               <img 
                 src={satsImg} 
                 alt="SATs Preparation" 
                 className="relative z-10 w-full rounded-3xl lg:rounded-tl-[100px] lg:rounded-br-[100px] shadow-2xl shadow-amber-900/10 object-cover h-[300px] md:h-[500px] lg:h-[600px] transform transition-transform duration-700 group-hover:scale-[1.02] border-4 border-white"
               />
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            <div className="lg:w-1/2 space-y-8 relative">
              ...
              <div className="flex flex-wrap gap-3">
                 {["1 to 1 Sessions", "Small Groups", "Past Paper Practice", "University Prep"].map((tag, i) => (
           ...
           <div className="flex flex-col md:flex-row items-center relative z-10">
              ...
              <div className="md:w-1/2 p-8 md:p-16 md:pl-0 text-left">
                 ...
                 <p className="text-slate-300 text-lg leading-relaxed mb-8 border-l-2 border-school-gold/30 pl-6">
                    Enrich your academic journey to grow your career.
                 </p>
...
export const PricingPageContent: React.FC = () => {
  ...
  const getColorClasses = (color: string) => {
    switch(color) {
      case 'amber': return { bg: 'bg-amber-50', text: 'text-amber-600', border: 'border-amber-100', ring: 'ring-amber-500/20', button: 'bg-amber-600 hover:bg-amber-700' };
      case 'rose': return { bg: 'bg-rose-50', text: 'text-rose-600', border: 'border-rose-100', ring: 'ring-rose-500/20', button: 'bg-rose-600 hover:bg-rose-700' };
      case 'indigo': return { bg: 'bg-indigo-50', text: 'text-indigo-600', border: 'border-indigo-100', ring: 'ring-indigo-500/20', button: 'bg-indigo-600 hover:bg-indigo-700' };
      case 'emerald': return { bg: 'bg-emerald-50', text: 'text-emerald-600', border: 'border-emerald-100', ring: 'ring-emerald-500/20', button: 'bg-emerald-600 hover:bg-emerald-700' };
      case 'cyan': return { bg: 'bg-cyan-50', text: 'text-cyan-600', border: 'border-cyan-100', ring: 'ring-cyan-500/20', button: 'bg-cyan-600 hover:bg-cyan-700' };
      default: return { bg: 'bg-slate-50', text: 'text-slate-600', border: 'border-slate-100', ring: 'ring-slate-500/20', button: 'bg-school-navy hover:bg-slate-800' };
    }
  };
  ...
  return (
    <div className="bg-slate-50 relative overflow-hidden">
      {/* Background Decorations */}
      <div className="absolute top-0 left-0 w-full h-[800px] bg-gradient-to-b from-school-navy/5 to-transparent -skew-y-3 origin-top-left -z-0"></div>
      <div className="absolute top-40 right-[-10%] w-[40%] h-[40%] bg-school-gold/5 rounded-full blur-[120px]"></div>
      <div className="absolute bottom-40 left-[-10%] w-[30%] h-[30%] bg-blue-500/5 rounded-full blur-[100px]"></div>
      ...
      <section className="py-20 lg:py-32 container max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-20 relative">
          ...
          <div className="absolute -top-10 left-1/2 -translate-x-1/2 w-full h-full pointer-events-none overflow-visible">
            <motion.div 
              ...
              className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[500px] border border-school-gold/10 rounded-full border-dashed"
            />
            <motion.div 
              animate={{ rotate: -360 }}
              transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
              className="absolute top-10 left-1/2 -translate-x-1/2 w-[400px] h-[400px] border border-school-navy/5 rounded-full"
            />
          </div>
          ...
          >
            <motion.h4 
              ...
              className="text-school-gold font-black uppercase text-2xl md:text-4xl mb-6 drop-shadow-[0_0_10px_rgba(212,175,55,0.3)]"
            >
            ...
            <motion.div 
              ...
              className="inline-flex items-center gap-3 px-6 py-2 bg-school-navy text-white rounded-full text-sm font-bold uppercase tracking-widest mb-10 shadow-2xl shadow-school-navy/30 border border-white/10"
            >
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-school-gold opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-school-gold"></span>
              </span>
              Limited time offer
            </motion.div>

            <h2 className="text-3xl md:text-5xl font-serif font-bold text-school-navy mb-8 leading-tight">
              ...
              <div className="overflow-hidden mb-2">
                <motion.span
                  ...
                  className="block"
                >
                  Quality education doesn't have to be
                </motion.span>
              </div>
              <div className="overflow-hidden">
                ...
                >
                  ...
                  <span className="relative inline-block mx-2 group">
                    <span className="relative z-10 text-school-gold transition-colors duration-300 group-hover:text-school-navy">
                    ...
                    <motion.span 
                      ...
                      className="absolute bottom-1 left-0 h-3 bg-school-gold/20 -z-0 rounded-sm"
                    />
                    <motion.span 
                      animate={{ 
                        opacity: [0.3, 0.6, 0.3],
                      ...
                      className="absolute -inset-2 bg-school-gold/10 blur-xl rounded-full -z-10"
                    />
                  </span>
                  with no contracts.
                </motion.span>
            ...
            <motion.div 
              ...
              className="h-1.5 bg-gradient-to-r from-transparent via-school-gold to-transparent mx-auto rounded-full mb-8"
            />
          </motion.div>
        </div>

        <div className="flex flex-wrap justify-center gap-8 lg:gap-10 items-stretch">
          {PRICING_PLANS.map((plan, i) => {
            ...
            return (
              <motion.div 
                ...
                className={`bg-white rounded-[3rem] shadow-2xl border border-slate-100 overflow-hidden flex flex-col relative group transition-all duration-500 hover:-translate-y-3 w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.7rem)] ${plan.popular ? `ring-8 ${colors.ring} scale-105 z-20` : 'z-10'}`}
              >
                {plan.popular && (
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 bg-school-gold text-school-navy text-[10px] font-black uppercase tracking-[0.2em] px-8 py-2.5 rounded-b-3xl shadow-md">
                    Most Popular
                  </div>
                )}
                ...
                <div className="p-10 md:p-12 flex-grow">
                  <div className="mb-10">
                    <div className={`inline-flex items-center justify-center w-12 h-12 ${colors.bg} ${colors.text} rounded-2xl mb-6 group-hover:rotate-12 transition-transform duration-500`}>
                      <Star className="w-6 h-6 fill-current" />
                    </div>
                    <h3 className="text-3xl font-serif font-bold text-school-navy mb-3">{plan.title}</h3>
                    <p className="text-gray-500 text-sm leading-relaxed min-h-[60px]">{plan.description}</p>
                  </div>

                  <div className="mb-10 flex items-baseline gap-2">
                    <span className="text-6xl font-black text-school-navy tracking-tighter">{plan.price}</span>
                  ...
                  <div className="space-y-5 mb-12">
                    {plan.features.map((feature, idx) => (
                      <div key={idx} className="flex items-center gap-4 group/item">
                        <div className={`w-6 h-6 rounded-full ${colors.bg} flex items-center justify-center shrink-0 group-hover/item:scale-110 transition-transform`}>
                          <Check className={`w-3.5 h-3.5 ${colors.text} stroke-[3px]`} />
                        </div>
                ...
                <div className="p-10 bg-slate-50/50 border-t border-slate-100">
                  <Link 
                    to="/contact" 
                    className={`w-full py-5 rounded-2xl font-black text-center flex items-center justify-center gap-3 transition-all shadow-xl hover:shadow-2xl active:scale-95 ${
                      plan.popular 
                        ? 'bg-school-gold text-school-navy hover:bg-yellow-500 shadow-school-gold/20' 
        ...
        {/* Flexible & Family-Friendly Pricing Section */}
        <div className="mt-32">
          <motion.div 
          ...
          >
            <h2 className="text-3xl md:text-5xl font-serif font-bold text-school-navy mb-4">Flexible & Family-Friendly Pricing</h2>
            <div className="w-24 h-1.5 bg-school-gold mx-auto rounded-full"></div>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {FLEXIBLE_PRICING_FEATURES.map((feature, idx) => (
              <motion.div 
                key={idx} 
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="w-16 h-16 bg-school-navy/5 rounded-2xl flex items-center justify-center text-school-navy mb-8 group-hover:scale-110 group-hover:bg-school-gold group-hover:text-school-navy transition-all duration-500">
                  {getIcon(feature.icon)}
                </div>
                <h3 className="text-2xl font-bold text-school-navy mb-4">{feature.title}</h3>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="mt-24 bg-school-navy text-white p-10 md:p-20 rounded-[4rem] shadow-2xl relative overflow-hidden group"
        >
          <div className="absolute top-0 right-0 w-96 h-96 bg-school-gold/10 rounded-full blur-[100px] -mr-48 -mt-48 transition-transform duration-1000 group-hover:scale-110"></div>
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-blue-500/10 rounded-full blur-[100px] -ml-48 -mb-48 transition-transform duration-1000 group-hover:scale-110"></div>
          
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="max-w-2xl text-center lg:text-left">
              <h3 className="text-4xl md:text-5xl font-serif font-bold mb-6 leading-tight">Ready to start your journey?</h3>
              <p className="text-blue-100/80 text-xl leading-relaxed">
                Join KRR Virtual Academy today and experience personalized learning that fits your family's lifestyle.
              </p>
            </div>
            <Link 
              to="/contact" 
              className="px-12 py-6 bg-school-gold text-school-navy rounded-full font-black text-xl hover:bg-yellow-500 transition-all shadow-2xl shadow-school-gold/20 whitespace-nowrap flex items-center gap-4 hover:scale-105 active:scale-95"
            >
              Book a free session <ArrowRight size={24} />
            </Link>
          </div>
        </motion.div>
      </section>
        ...
        <div className="space-y-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                 <div className="space-y-8">
                     {[
                         { title: "SATs (Key Stage 2)", desc: "Focusing on core arithmetic and mathematical reasoning.", icon: Sparkles },
...
export const EnglishPageContent: React.FC = () => {
    return (
        <div className="space-y-16">
            <div className="text-center max-w-3xl mx-auto">
                ...
                <h2 className="text-4xl font-serif font-bold text-school-navy mb-4">Master the Art of Language & Literature</h2>
                <p className="text-gray-600 text-lg">
                    English is the key to communication and critical thinking. We help students develop a deep appreciation for literature while mastering the technical skills of the language.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                 <div className="space-y-8">
                     {[
                         { title: "SATs (Key Stage 2)", desc: "Building essential skills in reading comprehension, writing, and grammar (SPaG).", icon: Sparkles },
                         { title: "Key Stage 3 English", desc: "Developing core foundations in literary analysis, creative writing, and critical reading.", icon: Quote },
                         { title: "GCSE English", desc: "Comprehensive preparation for Language and Literature exams with focus on text analysis and essay writing.", icon: FileText },
                         { title: "A-Level English", desc: "Rigorous training in literary criticism, advanced textual analysis, and essay structuring for university preparation.", icon: GraduationCap }
                     ].map((item, idx) => (
                         <div key={idx} className="flex gap-6">
                             <div className="flex-none w-14 h-14 bg-amber-50 rounded-2xl flex items-center justify-center">
                 ...
                 <div className="bg-gray-100 rounded-3xl p-8 relative">
                     ...
                     <h3 className="text-xl font-bold text-school-navy mb-6">Literary Analysis Challenge</h3>
                     <div className="space-y-4">
                         <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
                             <p className="font-mono text-sm text-amber-600 mb-2">Problem:</p>
                             <p className="text-gray-800 font-medium">Identify the literary device in the following sentence: "The wind whispered through the dark forest."</p>
                         </div>
                         <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
                             <p className="font-mono text-sm text-green-600 mb-2">Solution:</p>
                             <p className="text-gray-800 font-medium">Personification: Giving human qualities (whispering) to a non-human element (the wind) to create a vivid atmosphere.</p>
                         </div>
                     </div>
                     <div className="mt-8 text-center">
                         <Link to="/contact" className="inline-block w-full bg-amber-600 hover:bg-amber-700 text-white font-bold py-3 rounded-xl transition-colors">
                             Get English Support
                         </Link>
                     </div>
                 </div>
