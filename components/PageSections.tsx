    ...
    <div className="bg-slate-50 relative overflow-hidden">
      ...
      <section className="py-20 lg:py-32 container max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          {/* 
              Mobile Layout: Single Column. Order follows DOM: Title -> Map -> Form -> FAQ
              Desktop Layout: 12 Columns. Explicit placement using grid-row/col-start
          */}

          {/* 1. Title Section (Top Left on Desktop) */}
          <div className="lg:col-span-5 lg:row-start-1 w-full">
            <div className="mb-0">
          ...
          {/* 2. Map Section (Below Title on Desktop) */}
          <div className="lg:col-span-5 lg:row-start-2 w-full">
               <div className="flex items-center gap-3 mb-2">
                  <div className="p-2 bg-emerald-100 rounded-lg text-emerald-600"><MapPin size={24} /></div>
                  <h3 className="text-2xl font-serif font-bold text-school-navy">Our Location</h3>
               </div>
               <p className="text-sm text-gray-500 mb-4 italic pl-1">Visit our administrative office in the heart of London.</p>
               
               <div className="bg-white p-2 rounded-[2rem] shadow-sm border border-gray-200 h-[320px] relative group overflow-hidden">
                   <iframe 
                      width="100%" 
                      height="100%" 
                      id="gmap_canvas" 
                      src="https://maps.google.com/maps?q=71%E2%80%9375%20Shelton%20Street%2C%20Covent%20Garden%2C%20London%2C%20WC2H%209JQ&t=&z=15&ie=UTF8&iwloc=&output=embed" 
                      frameBorder="0" 
                      scrolling="no" 
                      marginHeight={0} 
                      marginWidth={0} 
                      className="rounded-[1.5rem] w-full h-full grayscale-[20%] group-hover:grayscale-0 transition-all duration-700"
                      title="KRR Academy Map"
                   ></iframe>
               </div>
          </div>

          {/* 3. Form Section (Right Column on Desktop, After Map on Mobile) */}
          <div className="lg:col-span-7 lg:col-start-6 lg:row-start-1 lg:row-span-3 w-full">
          ...
          {/* 4. FAQ Section (Below Map on Desktop, Last on Mobile) */}
          <div className="lg:col-span-5 lg:row-start-3 w-full border-t border-gray-200 pt-12">
