      ...
      >
        ...
        <div className="relative h-full flex flex-col p-6 overflow-y-auto">
          ...
          >
            ...
            >
              Book a free session <ArrowRight size={20} className="stroke-[3]" />
            </Link>
      ...
      <div className="container max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <Link to="/terms" className="text-slate-500 hover:text-school-gold text-sm transition-colors">Terms & Conditions</Link>
          </div>
        </div>
      </div>
    </footer>
