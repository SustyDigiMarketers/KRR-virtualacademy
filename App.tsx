...
import { 
  HeroSection, AboutPreview, AcademicHighlights, 
  ContactPageContent, ModernShowcase,
  ModernCodingUI, SciencePageContent, MathsPageContent, EnglishPageContent, TermsPageContent,
  PricingPageContent
...
const ScrollToTop = () => {
  ...
  useEffect(() => {
    ...
    switch(pathname) {
      ...
      case '/pricing': pageTitle = `Pricing | ${SCHOOL_NAME}`; break;
      ...
      */}
      <div className="sticky top-[92px] md:top-[120px] z-30 bg-white/95 backdrop-blur-md shadow-md border-b border-gray-100 py-4 transition-all duration-300">
         <div className="container mx-auto px-6 flex justify-center gap-8">
            {['science', 'maths', 'english'].map((section) => (
               <button
                  key={section}
      ...
      <div className="py-16 bg-gray-50">
         ...
         <div className="container mx-auto px-6"><div className="h-px bg-gray-200 my-12"></div></div>
         <div id="english" className="scroll-mt-48">
            <EnglishPageContent />
         </div>
      </div>
    </>
...
const PricingPage: React.FC = () => (
  <>
    <PageHeader title="Pricing" bgImage="https://picsum.photos/id/160/1920/600" />
    <PricingPageContent />
  </>
);
